...
📖 Background & History
This project originated from a long-standing architectural gap identified in the Py-ART community (Issue #719, 2018). After identifying that legacy tools like NCAR's REORDER were no longer maintained, the author spent nine years developing a standalone, hardware-accelerated alternative that avoids the memory overhead of standard KD-Trees.
🛠️ Installation
